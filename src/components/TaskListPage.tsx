...
export function TaskListPage({ onBack }: TaskListPageProps) {
    ...
    return (
        <div className="mx-auto flex h-full max-w-2xl flex-col px-6 py-10 font-body text-ink">
            <button
                onClick={onBack}
                className="mb-6 self-start text-sm font-medium text-ink underline decoration-dotted hover:cursor-pointer"
            >
                ← Back to board
            </button>
            ...
            <div className="mb-6 flex gap-2">
                ...
                <button
                    onClick={handleAdd}
                    className="rounded-md bg-pin-todo px-4 py-2 text-sm font-medium text-ink"
                >
                    Add
                </button>
            </div>
