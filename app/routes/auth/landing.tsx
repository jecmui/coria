        ...
        <div className="flex lg:flex-row flex-col items-center justify-center min-h-screen w-full gap-10 px-5">
            ...
            <div className="flex flex-col lg:max-w-[30vw] md:max-w-[50vw] sm:max-w-[75vw] max-w-screen text-center gap-5">
                ...
                <h2 className="sm:text-base text-sm">
                    Create a highly customizable productivity hub with a to-do
                    list, time tracking, calendar, and more, all at your
                    fingertips.
                </h2>
                <div className="flex flex-row items-center justify-center mt-2">
                    <Link
                        to={"register"}
                        className="block bg-(--color-primary-blue) hover:bg-(--color-primary-blue-dark) text-white px-6 py-3 rounded-2xl w-auto cursor-pointer mx-2 sm:text-base text-sm"
                    >
                        Get Started
                    </Link>
                </div>
